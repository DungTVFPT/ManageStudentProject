...
public class ScoreServiceImpl implements ScoreService{
	...
	@Override
	public List<String> getListSemester() {
	...
	@Override
	public List<String> getListSemesterByIdUser(String account_id) {
	...
	@Override
	public List<Score> getListAllScoreSemesterByIdUser(String account_id) {
		return scoreRepository.getListAllScoreSemesterByIdUser(account_id);
	}
